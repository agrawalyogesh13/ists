...
@media (max-width: 400px) {
    ...
    <body oncontextmenu=" return false " ><!-- Disabling right click -->
        ...
        <form action="saveResult" method="post" name="form" >
        <div class="header">
        ...
        <div class="footer">
            ...
            <input type="text" hidden id="response" name="response" ></input>
        ...
        <script type="text/javascript">
            ...
            var total_seconds=parseInt(600); //Duration of the test in seconds
            ...
            function nextQuestion(){
                ...
                timeout.innerHTML="<h2>QID : "+qarray[level][qno][6] +"</br></br>Current Score : "+current_pscore+"</br></br> Level : "+(level+1)+" </h2>";//Displaying QID in timeout section
                qno++;
                }
            ...
            function checkAnswer(){
                ...
                //Checking answer, whether correct/incorrect/(N/A)
...
//
                ...
                //     scoreID.innerHTML=current_pscore;
                  ...
                  //Logic for wrong answer ends here
                 responsetime=0;
             }
             ...
             function levelCalculator(x){
                 ...
                 responseID.value+=qarray[level][qno-1][7]+"$_$";     //solution, note - qarray[level][qno-1][6] par qid hai
                        ...
                        avg_pscore = parseFloat(((avg_pscore)*(no_of_obs)+(current_pscore))/(no_of_obs+1));
            ...
            if(current_pscore<=33){
                ...
                reset_bound = ((g_bound&c_bound)|(!g_bound&!c_bound));//(XOR = (a&b)|(!a&!b))
                g_bound=c_bound;
                return x;
                }
